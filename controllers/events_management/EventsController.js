...
module.exports = class EventsController {
  ...
  get_specific_events_(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      const myEventsObject = new EventsModel();
      var myEventsObjectPromise = myEventsObject.get_specific_events_(
        ColumnName,
        value_
      );
  ...
  batch_events__update(jsonObject_) {
    return new Promise(function(resolve, reject) {
      ...
      var myEventsObjectPromise = myEventsObject.batch_events__update(
        jsonObject_
      );
  ...
  individual_events__update(ColumnName, value_, jsonObject_) {
    return new Promise(function(resolve, reject) {
      ...
      var myEventsObjectPromise = myEventsObject.individual_events__update(
        ColumnName,
        value_
      );
  ...
  delete_events__record(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      ...
      var myEventsObjectPromise = myEventsObject.delete_events__record(
        ColumnName,
        value_
      );
