...
module.exports = class TicketsController {
  ...
  get_specific_tickets(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      const myTicketsObject = new TicketsModel();
      var myTicketsObjectPromise = myTicketsObject.get_specific_tickets(
        ColumnName,
        value_
      );
  ...
  batch_tickets_update(jsonObject_) {
    return new Promise(function(resolve, reject) {
      ...
      var myTicketsObjectPromise = myTicketsObject.batch_tickets_update(
        jsonObject_
      );
  ...
  individual_tickets_update(ColumnName, value_, jsonObject_) {
    return new Promise(function(resolve, reject) {
      ...
      var myTicketsObjectPromise = myTicketsObject.individual_tickets_update(
        ColumnName,
        value_
      );
  ...
  delete_tickets_record(ColumnName, value_) {
    return new Promise(function(resolve, reject) {
      ...
      var myTicketsObjectPromise = myTicketsObject.delete_tickets_record(
        ColumnName,
        value_
      );
